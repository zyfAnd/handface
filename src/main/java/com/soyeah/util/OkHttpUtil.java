...
//        //mOkHttpBuilder.cookieJar(new MyCookieJar());
     ...
     * @throws IOException
     */
    private String _postSyncString(String url,String json) throws IOException {
...
//            Log.i(TAG, "buildPostReqeust: "+" key:"+param.key +" value:"+param.value);
    ...
    public static String postSyncString(String url,String json) throws IOException {
        return getInstance()._postSyncString(url,json);
    }
}
